...
"""
irc-notifier documentation build configuration file.
...
project = 'irc-notifier'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'edX IRC Notifier'
...
#
# html_title = 'irc-notifier v0.1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'A small app which sends a message on IRC when certain signals are received',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'irc_notifier'),
                os.path.join(root_path, 'irc_notifier/migrations')])
